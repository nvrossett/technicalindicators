...
export class KSTInput extends IndicatorInput {
  public ROCPer1: number;
  public ROCPer2: number;
  public ROCPer3: number;
  public ROCPer4: number;
  public SMAROCPer1: number;
  public SMAROCPer2: number;
  public SMAROCPer3: number;
  public SMAROCPer4: number;
...
export class KST extends Indicator {
  ...
  public static calculate = kst;
  public result: KSTOutput[];
  public generator: IterableIterator<KSTOutput | undefined>;
